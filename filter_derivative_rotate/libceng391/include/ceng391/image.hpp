...
public:
	...
	void smooth_buffer(int n, uchar* buffer, int filter_size, float* gaussian_filter);
        void smooth_x(int filter_size ,float sigma);
	void smooth_y(int filter_size, float sigma);
	void smooth(int filter_size, float sigma){smooth(filter_size,sigma,sigma);}
	void smooth(int filter_size, float sigma_x, float sigma_y);
	
	short* derive_x();
	short* derive_y();

	void rotate(float theta);
	void rotate_center(float theta);
